...
namespace ToyShop.Repositories.Repositories
{
    ...
    {
        protected readonly ToyShopDBContext _context;
        protected readonly DbSet<T> _dbSet;

        public GenericRepository(ToyShopDBContext dbContext)
        {
            _context = dbContext;
        ...
        Task<PaginatedList<T>> IGenericRepository<T>.GetPagging(IQueryable<T> query, int index, int pageSize)
        {
